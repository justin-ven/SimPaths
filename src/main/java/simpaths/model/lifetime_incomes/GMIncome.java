...
public class GMIncome implements IDoubleSource {
    ...
    public GMIncome(int age, int year, Gender gender) {
        this.age = age;
        this.year = year;
        this.gender = gender;
        income = getEquivalisedIncome();
    }
    ...
    private double getEquivalisedIncome() {
        ...
        if (!Parameters.checkFinite(val)) {
            ...
            if (Gender.Male.equals(gender)) {
                val = Math.exp(Parameters.getRegLifetimeIncomeLI1a().getScore(this, DoublesVariables.class));
            } else {
                val = Math.exp(Parameters.getRegLifetimeIncomeLI1b().getScore(this, DoublesVariables.class));
            }
        }
        return val;
    }
